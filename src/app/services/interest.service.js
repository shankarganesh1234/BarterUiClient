...
var InterestService = (function () {
    ...
    InterestService.prototype.getInterestById = function (interestId) {
    ...
    InterestService.prototype.getInterestsForUser = function (userId) {
        return this.http.get(this.urls.getInterestsForUser + userId, this.options)
            .map(this.extractData)
            .catch(this.handleError);
    };
    InterestService.prototype.getOffersForUser = function (userId) {
